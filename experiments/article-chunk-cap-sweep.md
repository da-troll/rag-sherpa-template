...
5 cap values: **1000, 1500, 2000, 2500, 3500**. Overlap held constant at **300** across all runs. Each cap re-ingests all 16 articles into `recruitment-rag-3` (the per-doc `DELETE_BEFORE_INSERT` cleanly replaces prior vectors) and runs the same 20-question eval set.
